CREATE SCHEMA IF `BD_eleicao_ABP` DEFAULT CHARACTER SET utf8 ;
USE `BD_eleicao_ABP` ;

-- -----------------------------------------------------
-- Table `BD_eleicao_ABP`.`instituicao`
-- -----------------------------------------------------
CREATE TABLE IF `BD_eleicao_ABP`.`instituicao` (
...
-- -----------------------------------------------------
-- Table `BD_eleicao_ABP`.`eleicao`
-- -----------------------------------------------------
CREATE TABLE IF `BD_eleicao_ABP`.`eleicao` (
  `id` INT NOT NULL,
  ...
  INDEX `fk_eleição_instituição1_idx` (`instituição_id` ASC) VISIBLE,
...
CREATE TABLE IF `BD_eleicao_ABP`.`candidato` (
  `id` INT NOT NULL,
  ...
  INDEX `fk_candidato_eleição1_idx` (`eleição_id` ASC) VISIBLE,
...
CREATE TABLE IF `BD_eleicao_ABP`.`eleitor` (
  `id` INT NOT NULL,
...
CREATE TABLE IF `BD_eleicao_ABP`.`voto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_voto_candidato1_idx` (`candidato_id` ASC, `candidato_eleição_id` ASC) VISIBLE,
  INDEX `fk_voto_eleição1_idx` (`eleição_id` ASC, `eleição_instituição_id` ASC) VISIBLE,
  INDEX `fk_voto_eleitor1_idx` (`eleitor_id` ASC) VISIBLE,
